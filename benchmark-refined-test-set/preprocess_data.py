...
print(f'# of pos. entries after filtering: {df_pos.shape[0]}')
#remove cdrs cannot be clustered
df_clustered = pd.read_csv('../benchmark-test-set/output/gliph/output_gliph_pred.tsv', sep='\t')
df_pos = df_pos[df_pos['CDR3B'].isin(df_clustered['CDR3b'])].reset_index(drop=True)
print('remove cdr3bs connot be clustered')
print(f'# of pos. entries after filtering: {df_pos.shape[0]}')
...
print(f'# of pos. entries after filtering: {df_pos.shape[0]}')
#remove entries with cdr3b length > 20 and epitope length >= 8 and <= 12
...
print('Remove entries with cdr3b length > 20 and epitope length < 8 or > 12')
print(f'# of pos. entries after filtering: {df_pos.shape[0]}')
print(f'# of pos. entries after filtering: {df_pos.shape[0]}')
